...
<?php
include '../auth/login_handler.php';
?>
...
<head>
    ...
    <link rel="stylesheet" href="css/login-resposive.css">
    ...
    <div class="login-page-grid">
        <div class="item item-1">
            <div class="text">
                ...
                <div class="header">
                    <span>Greetings</span>
                    <span><span>BASC</span><span>Personnel!</span></span>
                </div>
        ...
        <div class="item item-2">
            <div class="forms-container">
                <form action="" method="POST" id="login-form">
                    ...
                    <div class="sub-text">Fill in your details below to log in and get started</div>
                    ...
                    <div class="forgot-password">Forgot your password?
